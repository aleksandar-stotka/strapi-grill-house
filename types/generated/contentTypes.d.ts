...
export interface ApiAboutuspageAboutuspage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    burgerphoto: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    ...
    ownerphoto: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGrillmenuGrillmenu extends Struct.CollectionTypeSchema {
  collectionName: 'grillmenus';
  info: {
    description: '';
    displayName: 'grillmenu';
    pluralName: 'grillmenus';
    singularName: 'grillmenu';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    grildescription: Schema.Attribute.Text;
    grillmenuimage: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::grillmenu.grillmenu'
    > &
      Schema.Attribute.Private;
...
export interface ApiHeroHero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    aboutusImage: Schema.Attribute.Media<
    ...
    descriptionAbout: Schema.Attribute.Blocks;
    Grill: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    skarahouse: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ingrediantsText: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    menudescription: Schema.Attribute.String;
...
export interface ApiSliderSlider extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cardprice: Schema.Attribute.Integer;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::grillmenu.grillmenu': ApiGrillmenuGrillmenu;
